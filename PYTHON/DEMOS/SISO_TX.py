...
def siggen_app(args, rate, ampl, ant, gain, freq, bbfreq, waveFreq, numSamps, serial1, serial2, sigType, lo_tone):
    """
...
def main():
    ...
    parser.add_option("--ant", type="string", dest="ant", help="Optional Tx antenna", default="AB")
    ...
    parser.add_option("--serial1", type="string", dest="serial1", help="serial number of the device", default="RF3E000017")
    parser.add_option("--serial2", type="string", dest="serial2", help="serial number of the device", default="RF3E000009")
