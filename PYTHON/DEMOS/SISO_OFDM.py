...
def main():
    ...
    parser.add_option("--serialTx", type="string", dest="serialTx", help="Serial # of TX device", default="RF3E000008")
    parser.add_option("--serialRx", type="string", dest="serialRx", help="Serial # of RX device", default="RF3E000018")
