...
if __name__ == '__main__':
	...
	parser.add_argument("--txserial", type=str, dest="txserial", help="TX SDR Serial Number, e.g., 00001", default="RF3E000008")
	parser.add_argument("--rxserial", type=str, dest="rxserial", help="RX SDR Serial Number, e.g., 00002", default="RF3E000018")
